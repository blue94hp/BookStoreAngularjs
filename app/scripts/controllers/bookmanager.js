...
/**
 * @ngdoc function
 * @name bookstoreApp.controller:BookmanagerCtrl
 * @description
 * # BookmanagerCtrl
...
bookstoreApp.controller('BookmanagerCtrl', function ($scope,$http,$sce) {
   ...
   //    	$scope.imagePath = $sce.trustAsResourceUrl(fileURL);
    ...
    .success(function(data, status) {   
  	...
  	// $scope.imagePath = "http://localhost:8080/api/image";
   	...
   	$http.get('http://localhost:8080/api/books?page=0&size=10').success(function(data){
   			$scope.books = data;
   		});
